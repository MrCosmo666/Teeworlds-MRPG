...
#define GAME_RELEASE_VERSION "2.0.0"

// ~~ RELEASE CLIENT SIDE VERSION
#define CLIENT_RELEASE_VERSION "1.1.8"

// ~~ RELEASE SERVER SIDE VERSION
#define SERVER_RELEASE_VERSION "1.5.0"
...
#define PROTOCOL_VERSION_MMO 1024
