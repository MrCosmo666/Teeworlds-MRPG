...
void CVoting::AddOption(const char *pDescription, vec3 Color, const char *pIcon)
{
	...
	str_copy(pOption->m_Icon, pIcon, sizeof(pOption->m_Icon));
	++m_NumVoteOptions;
}
