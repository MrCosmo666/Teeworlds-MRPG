...
# mmotee
image_mmotee = Image("mmoeffect", "effx/mmotee.png")
image_teleport = Image("teleporteffect", "effx/teleport.png")
image_wingit23 = Image("wingsit23", "wings/it23.png")
image_wingit24 = Image("wingsit24", "wings/it24.png")
image_wingit25 = Image("wingsit25", "wings/it25.png")
image_wingit27 = Image("wingsit27", "wings/it27.png")
image_wingit28 = Image("wingsit28", "wings/it28.png")
image_mmogame = Image("mmogame", "mmogame.png")
...
# mmotee
container.images.Add(image_mmotee)
container.images.Add(image_teleport)
container.images.Add(image_wingit23)
container.images.Add(image_wingit24)
container.images.Add(image_wingit25)
container.images.Add(image_wingit27)
container.images.Add(image_wingit28)
...
# mmotee
set_mmotee = SpriteSet("mmotee", image_mmotee, 4, 4)
set_teleport = SpriteSet("teleport", image_teleport, 8, 1)
set_wingsit23 = SpriteSet("wingsit23", image_wingit23, 1, 1)
set_wingsit24 = SpriteSet("wingsit24", image_wingit24, 1, 1)
set_wingsit25 = SpriteSet("wingsit25", image_wingit25, 1, 1)
set_wingsit27 = SpriteSet("wingsit27", image_wingit27, 1, 1)
set_wingsit28 = SpriteSet("wingsit28", image_wingit28, 1, 1)
...
container.spritesets.Add(set_wingsit24)
container.spritesets.Add(set_wingsit25)
container.spritesets.Add(set_wingsit27)
container.spritesets.Add(set_wingsit28)
