...
#gui
container.sounds.Add(SoundSet("book_flip", FileList("audio/mmotee/book_flip-%02d.wv", 2)))
...
container.sounds.Add(SoundSet("key_press", ["audio/mmotee/ui_key_press.wv"]))
...
container.sounds.Add(SoundSet("item_sell_buy", ["audio/mmotee/item_sell_buy.wv"]))
...
image_relax = Image("relax", "mmotee/effx/relax.png")
image_teleport = Image("teleport", "mmotee/effx/teleport.png")
image_mmogame = Image("mmogame", "mmotee/mmogame.png")
image_mmogamehud = Image("mmogamehud", "mmotee/hud-icons.png")
...
container.images.Add(image_mmogamehud)
...
container.images.Add(Image("shadow_wings", "mmotee/wings/shadow_wings.png"))
container.images.Add(Image("neptune_wings", "mmotee/wings/neptune_wings.png"))
container.images.Add(Image("angel_wings", "mmotee/wings/angel_wings.png"))
...
container.images.Add(Image("eagle_little_wings", "mmotee/wings/eagle_little_wings.png"))
container.images.Add(Image("necromante_wings", "mmotee/wings/necromante_wings.png"))
...
set_mmogamehud = SpriteSet("mmo_game_hud", image_mmogamehud, 5, 4)
...
set_mmorifle = SpriteSet("mmorifle", image_mmorifle, 4, 6)
...
container.spritesets.Add(set_mmogamehud)
...
container.sprites.Add(Sprite("mmo_game_side_arrow", set_mmogame, 4, 0, 1, 1))
container.sprites.Add(Sprite("mmo_game_main_arrow", set_mmogame, 5, 0, 1, 1))
container.sprites.Add(Sprite("mmo_game_effect", set_mmogame, 6, 0, 1, 1))
container.sprites.Add(Sprite("mmo_game_drop", set_mmogame, 7, 0, 1, 1))
...
container.sprites.Add(Sprite("hud_icon_mail", set_mmogamehud, 0,0,1,1))
container.sprites.Add(Sprite("hud_icon_quest", set_mmogamehud, 1,0,1,1))
...
container.sprites.Add(Sprite("mmo_gun_heaven_muzzle2", set_mmogun, 4, 0, 2, 1))
...
container.sprites.Add(Sprite("mmo_shotgun_heaven_muzzle1", set_mmoshotgun, 4, 0, 2, 1)) # +2 muzzle
container.sprites.Add(Sprite("mmo_shotgun_heaven_muzzle2", set_mmoshotgun, 6, 0, 2, 1))
...
anim.wings.frames.Add(AnimKeyframe(0.6, 0, 0, 0.01))
anim.wings.frames.Add(AnimKeyframe(0.7, 0, 0, 0.02))

anim.wings.frames.Add(AnimKeyframe(1.0, 0, 0, 0.0)) # yes jump and air
anim.wings.frames.Add(AnimKeyframe(1.2, 0, 0, -0.08))
anim.wings.frames.Add(AnimKeyframe(1.3, 0, 0, -0.05))
anim.wings.frames.Add(AnimKeyframe(1.4, 0, 0, 0.08))
anim.wings.frames.Add(AnimKeyframe(1.5, 0, 0, 0.0))

anim.wings.frames.Add(AnimKeyframe(2.0, 0, 0, -0.01)) # no jump air
anim.wings.frames.Add(AnimKeyframe(2.2, 0, 0, -0.05))
anim.wings.frames.Add(AnimKeyframe(2.3, 0, 0, -0.06))
