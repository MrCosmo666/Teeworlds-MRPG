<?php
	...
	$str = "{I have|I stagger|I love|Santa Barbara|Big|Small|Medium} {Tee|Bird|F***|Tiger|buggy}";
	...
	imagettftext($img, 12 + $font_size, 0, 60, 120, $randomcolor, $font, "$player - Rank #$rank");
	imagettftext($img, $font_size5, 0, 62, 170, $whitecolor, $font, "Level:");
	imagettftext($img, $font_size5, 0, 260, 170, $whitecolor, $font, "Satiety:");
	imagettftext($img, 6 + $font_size, 0, 60, 280, $whitecolor, $font, $str);

	// текст который получаем
	imagettftext($img, $font_size, 0, 140, 174, $randomcolor, $font, $level);
	imagettftext($img, $font_size, 0, 360, 174, $randomcolor, $font, "$hungry%");
